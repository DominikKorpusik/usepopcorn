...
export default function StarRating({
  ...
  if (messages.length > 0 && messages.length !== maxRating) {
    throw new Error("Messages length should match maxRating");
  }

  if (defaultRating > maxRating) {
    throw new Error("Default rating should not exceed maxRating");
  }
...
function Star({ full, onHoverIn, onHoverOut, onRate, options }) {
